...
function drawDOWNLOADDetail() {
    if (document.getElementById("downloadDetail")) {
        d3.csv("resources/download-usage.csv", function (data) {
            data.forEach(function (d) {
                data.USAGE = +data.USAGE;
                //console.log(data);
            })
            var ctx = document.getElementById("downloadDetail").getContext('2d');
            var downloadDetail = new Chart(ctx, {
                type: 'line',
                data: {
                    labels: [
                        data[0].DATE,
                    ...
                    datasets: [{
                        ...
                        label: "Network Download Usage (kb/s)",
                        borderColor: "#007bff",
                        fill: true
                    }]
                }
