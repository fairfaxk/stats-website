...
function drawUPLOADDetail() {
    if (document.getElementById("uploadDetail")) {
        d3.csv("resources/upload-usage.csv", function (data) {
            data.forEach(function (d) {
                data.USAGE = +data.USAGE;
                //console.log(data);
            })
            var ctx = document.getElementById("uploadDetail").getContext('2d');
            var uploadDetail = new Chart(ctx, {
                type: 'line',
                data: {
                    labels: [
                        data[0].DATE,
                    ...
                    datasets: [{
                        ...
                        label: "Network Upload Usage (kb/s)",
                        borderColor: "#007bff",
                        fill: true
                    }]
                },
